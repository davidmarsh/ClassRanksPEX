package praxis.slipcor.classranksPEX;
...
import praxis.slipcor.classranksPEX.CRPlayers;
...
public class CRClasses {
	...
	public static void classAdd(String world, String player, String cString) {
		...
		if (ClassRanks.permissionHandler != null) {
			...
			for(int i=0;i<worlds.length;i++) {
				try {
					ClassRanks.permissionHandler.getUser(player).addGroup(cString, world);
				} catch (Exception e) {
	...
	public static void rankAdd(String world, String player, String rank) {
		...
		if (ClassRanks.permissionHandler != null) {
			...
			for(int i=0;i<worlds.length;i++) {
				try {
					ClassRanks.permissionHandler.getUser(player).addGroup(rank, world);
				} catch (Exception e) {
	...
	public static void classRemove(String world, String player, String cString) {
		...
		if (ClassRanks.permissionHandler != null) {
			...
			for(int i=0;i<worlds.length;i++) {
				try {
					ClassRanks.permissionHandler.getUser(player).removeGroup(cString, world);
				} catch (Exception e) {
					ClassRanks.log("PermName " + cString + " or user " + player + " not found in world " + worlds[i], Level.WARNING);
				}
			}
	...
	public static boolean isInGroup(String world, String permName, String player) {
		return ClassRanks.permissionHandler.getUser(player).inGroup(permName);
		
		
		
		
		
		// margin because of lines
